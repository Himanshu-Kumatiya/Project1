...
<body>
    <header id="header">
        <div id="logo">
            <span style="color: rgb(250, 234, 12);">Digital</span><span style="color: rgb(226, 120, 6);">Notes</span>
        </div>
        <div id="buttons">
        ...
        <div id="signbutt">
            <button class="signcls" id="singup"><a href="signup.php">Signup</a></button>
            <button class="signcls" id="login"><a href="login.php">Login</a></button>
        </div>
    </header>
    <section id="text">
        <div id="text1">
